...
export function useProjectForm(loadProjects) {
  ...
  function editProject(project) {
    ...
    projectForm.value = {
      ...
      series_script_config: { ...DEFAULT_SERIES_SCRIPT_CONFIG, ...(project.series_script_config || {}) },
      movie_script_config: { ...DEFAULT_MOVIE_SCRIPT_CONFIG, ...(project.movie_script_config || {}) },
