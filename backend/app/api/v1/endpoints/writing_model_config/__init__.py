...
from ._schemas import (
    WritingModelConfigCreate,
    WritingModelConfigUpdate,
    WritingModelConfigResponse,
    WritingModelConfigTestRequest,
    WritingModelConfigImportItem,
    WritingModelConfigImportRequest,
    WritingModelConfigExportItem,
    WritingModelConfigExportResponse,
)
...
def config_to_response(config: WritingModelConfig) -> WritingModelConfigResponse:
    ...
    try:
        ...
        logger.warning(f"解密API Key失败: config_id={config.id}, error={e}")
        api_key_masked = "***解密失败***"
