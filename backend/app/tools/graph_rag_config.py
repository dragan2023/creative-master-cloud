...
GENERAL_KB_CONFIG = {
    ...
    "entity_types": {
        ...
        # ========== 新增实体类型（基于番茄课堂理论萃取）==========
        "金手指设计": {
            "description": "主角特殊能力/外挂的设计原理和方法，包括系统、空间、灵泉等",
            "theory_tags": ["系统设计", "能力设定", "成长机制", "限制平衡"],
            "examples": ["花钱返利系统", "签到系统", "选择系统", "空间灵泉", "怨念值系统"]
        },
        "爽点机制": {
            "description": "产生阅读快感的心理机制和实现方法",
            "theory_tags": ["反差爽感", "情绪曲线", "打脸机制", "满足感"],
            "examples": ["反差爽点", "期待感满足", "暧昧期拉长", "暴富态度转变"]
        },
        "人物塑造法": {
            "description": "角色设计的理论方法和实践技巧",
            "theory_tags": ["人设优先级", "记忆点", "反差设计", "缺点设计"],
            "examples": ["反差+缺点人设法", "四步人物塑造法", "反派天赋+悲惨际遇法", "群像塑造"]
        },
        "节奏控制法": {
            "description": "剧情节奏把控的理论和工具",
            "theory_tags": ["节奏心电图", "LOCK系统", "环环相扣", "波峰波谷"],
            "examples": ["LOCK事件闭环法", "节奏心电图模型", "环环相扣原理", "摊煎饼原理"]
        },
        "开篇设计法": {
            "description": "开篇吸引读者的策略和技巧",
            "theory_tags": ["黄金三章", "冲突切入", "代入感", "充值率"],
            "examples": ["黄金三章冲突切入法", "开篇代入感三要素法", "开篇充值率导向设计法"]
        },
        "悬念设计": {
            "description": "制造和维持悬念的方法论",
            "theory_tags": ["悬念构建", "期待感", "好奇心", "揭秘节奏"],
            "examples": ["大环套小环悬念法", "时间倒计时紧张感法", "挖坑本工具"]
        },
        "代入感营造": {
            "description": "让读者产生情感共鸣的技巧",
            "theory_tags": ["共情机制", "社会热点", "生活化", "接地气"],
            "examples": ["五维代入感营造法", "代入感即共情原理", "接地气人设"]
        },
        "创作工具": {
            "description": "辅助创作的实用工具和方法",
            "theory_tags": ["大纲规划", "素材积累", "检查清单", "练习方法"],
            "examples": ["挖坑本", "灵感三本法", "双轴时间线", "人设标签法"]
        },
        "创新方法": {
            "description": "突破套路、实现差异化的创作策略",
            "theory_tags": ["元素融合", "反套路", "差异化", "新瓶装旧酒"],
            "examples": ["神豪+元素融合法", "写烂避免重复法", "多元素融合法"]
        }
    },
    "relation_types": {
        ...
        # ========== 新增关系类型 ==========
        "服务于": {"description": "方法/工具服务于某个目标或原理", "weight_range": (0.7, 0.95)},
        "包含": {"description": "理论/方法包含子方法或子概念", "weight_range": (0.8, 1.0)},
        "违背": {"description": "创新方法打破常规理论", "weight_range": (0.6, 0.85)}
    }
}
...
VERTICAL_KB_CONFIGS = {
    ...
    "novel-writing": {
        ...
        "entity_types": {
            ...
            "风格流派": {
                "description": "小说写作风格与流派特征,包含传统文学流派、作家个人风格、网络小说风格、语言叙事特色四大类(共61种)",
                "connection_focus": ["风格理论", "文学传统", "审美心理学", "文化认同"],
                "style_categories": {
                    "traditional": "传统文学流派(17种): 现实主义、浪漫主义、魔幻现实主义、现代主义、自然主义、存在主义、哥特式、超现实主义、后现代主义、极简主义、意识流、讽刺文学、寓言象征、古典侦探、史诗英雄、田园乡土",
                    "personal": "作家个人风格(14种): 海明威式简洁、余华式冷峻、莫言式魔幻乡土、张爱玲式细腻、鲁迅式锋利、马尔克斯式魔幻、卡夫卡式荒诞、卡尔维诺式奇想、沈从文式抒情、王小波式机智、古龙式冷艳、金庸式宏大",
                    "web_novel": "网络小说风格(22种): 升级流/爽文、无限流、重生/穿越流、系统流、古言/宫斗、都市异能/玄幻、发疯/发癫文学、博弈型叙事、无CP大女主、考据式穿越、公路文/公路求生、规则怪谈、中式克苏鲁、修仙2.0/赛博修仙、民俗灵异、第四天灾流、进化流、聊天群流、天幕文、反套路、短篇化/知乎风、东方美学叙事",
                    "narrative": "语言叙事特色(8种): 诗化/散文化、戏剧化、幽默风趣、悬疑惊悚、抒情现实主义、书信/日记体、多视角叙事、口语化/说书体"
                }
            }
        },
        "relation_types": {
...
### 原有6种基础类型
- **创意理论**: 经典创意方法论（头脑风暴、SCAMPER等）
- **叙事结构**: 故事构建框架（三幕式、英雄之旅等）
- **情感要素**: 情感触发点（共鸣点、冲突点等）
- **受众画像**: 目标人群特征（Z世代、宝妈等）
- **平台特性**: 平台内容特点（抖音算法、小红书种草等）
- **认知理论**: 心理学原理（峰终定律、蔡格尼克效应等）

### 新增9种网文创作类型
- **金手指设计**: 系统、外挂、特殊能力的设计原理（系统类型、成长机制、限制条件）
- **爽点机制**: 产生阅读快感的方法（反差爽点、期待感、情绪曲线）
- **人物塑造法**: 角色设计技巧（人设优先级、记忆点、反差设计、群像塑造）
- **节奏控制法**: 剧情节奏把控（LOCK系统、节奏心电图、环环相扣）
- **开篇设计法**: 开篇吸引读者策略（黄金三章、冲突切入、充值率）
- **悬念设计**: 悬念制造方法（大环套小环、时间倒计时、挖坑本）
- **代入感营造**: 情感共鸣技巧（五维代入感、共情机制、生活化）
- **创作工具**: 辅助创作工具（挖坑本、灵感三本、双轴时间线）
- **创新方法**: 差异化策略（元素融合、反套路、新瓶装旧酒）
